...
func _place_player() -> void:
	if name != LevelManager.target_transition:
		return
	get_tree().get_first_node_in_group("CameraManagerGroup").jane_pcam.global_position = global_position + LevelManager.position_offset
	get_tree().get_first_node_in_group("CameraManagerGroup").john_pcam.global_position = global_position + LevelManager.position_offset	
...
func get_offset() -> Vector2:
	...
	var player_pos = PlayerManager.active_player.global_position
